...
HD_PWD='C:/RISC_FYP/RISC-VV/RISCV_vicilogic/xilinxprj/WB/wb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WB.tcl

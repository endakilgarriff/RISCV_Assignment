...
HD_PWD='C:/RISC_FYP/RISC-VV/RISCV_vicilogic/xilinxprj/IF/IF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_IF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCV_IF.tcl
